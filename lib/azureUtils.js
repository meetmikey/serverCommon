...
exports.getFileBlueSky = function(azurePath, callback) {

  if ( ! azurePath ) { callback( winston.makeMissingParamError('azurePath') ); return; }
  // blobs, as streams
  var container = s.container(conf.azure.container);
  
  container.get(azurePath, function (err, res) {

  })
//  .pipe(c2.put('archive.txt'));
