...
esUtils.resetFailCount = function() {
  consecutiveFailCount = 0;
}

esUtils.incrementFailCount = function() {
  consecutiveFailCount += 1;

  if (consecutiveFailCount >= constants.MAX_NGINX_TIMEOUTS) {
    sqsConnect.setStopSignalForQueue ('Worker', ' too many consecutive indexing fails.');
    sqsConnect.setStopSignalForQueue ('WorkerQuick', ' too many consecutive indexing fails.');
    sqsConnect.setStopSignalForQueue ('WorkerReindex', ' too many consecutive indexing fails.');
  }
}
