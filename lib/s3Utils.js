...
exports.uploadResponseToS3 = function(response, s3Path, callback) {
  ...
  clientPutStreamhasCalledBack = false;
...
exports.putBufferAttempt = function( buffer, s3Path, headers, attempts, callback ) {
  ...
  var tempUniqueId = utils.getQuickUniqueId(5);

  clientPutBufferHasCalledBack = false;
  winston.doInfo('about to putBuffer', {tempUniqueId: tempUniqueId});
  s3Utils.client.putBuffer( buffer, s3Path, headers, function(err, res) {
    ...
    if ( clientPutBufferHasCalledBack ) {
      ...
      winston.doWarn('Double callback from s3Utils.client.putBuffer, ignoring', {err: err, tempUniqueId: tempUniqueId});

    } else {
      winston.doInfo('putBufferAttempt: ok', {tempUniqueId: tempUniqueId});
...
exports.getFile = function(s3Path, useGzip, callback) {
  ...
  clientGetFileHasCalledBack = false;
...
exports.deleteFile = function(s3Path, callback) {
  ...
  clientDeleteFileHasCalledBack = false;
