...
exports.putBufferAttempt = function( buffer, s3Path, headers, attempts, callback ) {
  ...
  var tempUniqueId = utils.getQuickUniqueId();
  winston.doInfo('about to putBuffer', {s3Path: s3Path, size: buffer.length, tempUniqueId: tempUniqueId});

  s3Utils.client.putBuffer( buffer, s3Path, headers, function(err, res) {

    winston.doInfo('putBuffer returned', {s3Path: s3Path, size: buffer.length, tempUniqueId: tempUniqueId});
