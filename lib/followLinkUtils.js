...
exports.followLinkSaveAndUpload = function( linkInfo, userId, callback ) {
  ...
  followLinkUtils.checkAndFollowLink( linkInfo, userId, function( err, linkFollowData, mimeType ) {
    if ( err ) {
      callback( err );
...
exports.checkAndFollowLink = function( linkInfo, userId, callback ) {
  ...
  followLinkUtils.checkURLDomain( url, function(err, urlDomainIsOK) {
    if ( err ) {
      ...
      followLinkUtils.followLink( linkInfo, userId, function( followLinkErr, linkFollowData, mimeType ) {
        isSuccess = true;
...
exports.recordURLDomainResult = function( url, isSuccess, callback ) {
  ...
  LinkDomainResultModel.findOneAndUpdate( {domain: domain}, increment, options, function(err, updatedURLDomainResult) {
    if ( err ) {
      ...
      winston.doInfo('no updatedURLDomainResult');
        ...
        if ( err ) {
          ...
          async.each( foundLinks, function( foundLink, eachCallback ) {
            ...
            if ( ! foundLink.isPromoted ) {
              ...
              indexingHandler.createIndexingJobForDocument( foundLink, true, false, eachCallback );
            }
