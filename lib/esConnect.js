...
exports.checkIndex = function(callback) {
  ...
  var indexURL = esConnect.getProtocol() + esConnect.conf.elasticSearch.host + ':' + esConnect.conf.elasticSearch.port + '/' + esConnect.conf.elasticSearch.indexName;
...
exports.checkAlias = function (aliasName, callback) {
  var indexURL = esConnect.getProtocol() + esConnect.conf.elasticSearch.host + 
    ':' + esConnect.conf.elasticSearch.port + '/' + aliasName + "_" + esConnect.indexName;
