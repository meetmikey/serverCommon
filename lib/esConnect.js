...
exports.init = function( conf, callback ) {
  ...
  async.series([
    ...
    , esConnect.startPollingNodes
    , esConnect.startPollingHealth
  ], function( err ) {
    callback(err);
  });
}
...
exports.startPollingNodes = function (callback) {
  // callback right away
  callback();
  ...
  setInterval (function () {
    ...
    esConnect.getClient().discoverNodes();
  }, 60000);
}

exports.startPollingHealth = function (callback) {
  // callback right away
  callback();
  var sentWarning = false;

  setInterval (function () {
    winston.doInfo ('polling es health');
    esConnect.getClient().health()
      .on('data', function(data) {    
        var health = JSON.parse (data);
