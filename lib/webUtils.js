...
exports.webGetWithoutRedirects = function( url, callback ) {
  webUtils.webGetWithRedirects( url, 0, callback );
}
...
exports.webGetWithRedirects = function( url, numRedirectsToFollow, callback ) {
  ...
  webUtils.webGetAttempt( url, remainingRedirectsToFollow, url, callback );
}
  ...
  if ( ! response ) {
    ...
    if ( ! responseCode ) {
      ...
      if ( remainingRedirectsToFollow <= 0 ) {
        ...
        webUtils.webGetAttempt( redirectURL, remainingRedirectsToFollow, originalURL, callback );
      }
