...
exports.getLikeEmail = function( user, model, type, isPreview, callback ) {
  ...
  templateDataMethod( user, model, type, isPreview, function(err, modelTemplateData, emailAttachments) {
    if ( err ) {
      callback( err );
...
exports.getLinkTemplateData = function( user, link, type, isPreview, callback ) {
  var templateData = {};
...
//callback should return err, modelTemplateData, emailAttachments
exports.getAttachmentTemplateData = function( user, attachment, type, isPreview, callback ) {
  ...
  templateData['fileSize'] = attachment.fileSize;
