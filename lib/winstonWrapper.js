...
winston.makeMongoError = function(mongoErrInput, skipStacktraceLinesInput) {
  var skipStacktraceLines = 4;
  if ( skipStacktraceLinesInput ) {
    skipStacktraceLines = skipStacktraceLinesInput;
  }
...
winston.makeAzureError = function(azureErr, skipStacktraceLinesInput) {
  var skipStacktraceLines = 4;
  if ( skipStacktraceLinesInput ) {
    skipStacktraceLines = skipStacktraceLinesInput;
  }
  var error = winston.makeResponseError('azure error', 500, 'internal error', {azureErr: azureErr}, skipStacktraceLines);
  return error;
}
