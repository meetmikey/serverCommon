...
exports.getComparableURL = function( url ) {
  ...
  //Drop trailing slash...
  while ( comparableURL.substring( comparableURL.length - 1 ) == '/' ) {
    comparableURL = comparableURL.substring(0, ( comparableURL.length - 1 ) );
  }
  ...
  request( url,
    function (error, response, body) {
      ...
      if ( error || ( ! response ) || ( response.statusCode !== 200 ) ) {
        callback( winston.makeError('error resolving URL') );
