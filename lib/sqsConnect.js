...
exports.pollMailReaderQueue = function( handleMessage, maxHandlers ) {
  this.pollQueue( mailReaderQueue, handleMessage, maxHandlers, 'mailReaderQueue', constants.MAIL_READER_CHECK_INTERVAL);
}

exports.pollMailReaderQuickQueue = function( handleMessage, maxHandlers ) {
  this.pollQueue( mailReaderQuickQueue, handleMessage, maxHandlers, 'mailReaderQuickQueue', constants.MAIL_READER_QUICK_CHECK_INTERVAL);
}
