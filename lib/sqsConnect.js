...
exports.addMessageToWorkerQuickQueue = function( message, callback ) {
  sqsConnect.addMessageToQueue( workerQuickQueue, QUEUE_NAME_WORKER_REINDEX, message, 0, callback );
}
exports.pollWorkerQuickQueue = function( handleMessage, maxWorkers, workerTimeout ) {
  sqsConnect.pollQueue( workerQuickQueue, QUEUE_NAME_WORKER_REINDEX, handleMessage, maxWorkers, workerTimeout );
}
