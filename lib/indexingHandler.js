...
exports.indexAttachmentFile = function( attachment, parsedMailAttachment, resourceId ) {
...
exports.updateLinkInfoIndexState = function( linkInfo, esUtilsError ) {
  ...
  if ( esUtilsError ) {
    ...
    updateSet['$set']['indexState'] = esUtilsError.message;
  }
...
exports.indexResource = function( resource, resourceBytes, resourceId, isLinkInfo ) {
