...
exports.indexAttachment = function(attachment, attachmentBytes, mail) {
  var fileContentId = attachmentUtils.getFileContentId( attachment );
  winston.doInfo('indexing attachment: ' + fileContentId);

  indexingHandler.indexResource (attachment, attachmentBytes.content, fileContentId, false);
  indexingHandler.indexResourceMetadata (attachment, mail, fileContentId, false);

}

exports.indexResource = function (resource, resourceBytes, resourceId, isLink) {
...
exports.indexResourceMetadata = function (resource, mail, parentId, isLink) {
...
exports.updateResourceMetadata = function (resource, mail, resourceId, isLink) {
  indexingHandler.indexResourceMetadata (resource, mail, resourceId, isLink)
}
