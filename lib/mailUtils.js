...
exports.isAttachmentImage = function( attachment ) {
  ...
  return getDocType (attachment.contentType) === 'image' 
    && !mailUtils.excludeFromImages (attachment.contentType);
...
exports.getDocType = function (contentType) {
  ...
  else if (mailUtils.isContentTypeCandidate (contentType, 'photoshop')) {
    return 'photoshop';    
  }
  ...
  cloudStorageUtils.getFile( cloudStoragePath, false, inAzure, function(err, res) {
    if ( err ) {
      ...
      res.on('end', function() {
        ...
        winston.doInfo('completed getFile', {cloudStoragePath: cloudStoragePath, dataSize: dataSize, elapsedTime: elapsedTime, metric: metric});
